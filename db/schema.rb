...
ActiveRecord::Schema.define(version: 20_210_927_043_744) do
  ...
  create_table 'shinto_param_items', force: :cascade do |t|
    t.string 'title'
    t.float 'points'
    t.bigint 'shinto_param_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['shinto_param_id'], name: 'index_shinto_param_items_on_shinto_param_id'
  end
  ...
  add_foreign_key 'shinto_param_items', 'shinto_params'
